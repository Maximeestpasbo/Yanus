...
public abstract class Monster extends Living implements Runnable, DemisableObserver, ExplodableObserver, Demisable{
	...
	public Monster(int posX, int posY, int x, int y, int color, Game game, int mVision, int lp) {
		super(posX, posY, color, lp , timeTS);  //attribut commun � toutes les filles de GameObject, pas besoin de les sp�cifier dans chacune 
...
observers.add(po); //ajoute game � la liste observers pour pouvoir l'enlever de l'�cran le moment venu	
}

@Override
public void demisableNotifyObserver() {
for (DemisableObserver o : observers) {
o.demise(this, null); //enl�ve ennemi quand mort
}	
}
